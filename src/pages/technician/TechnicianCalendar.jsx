...
export default function TechnicianCalendar() {
  ...
  const calendarGrid = useMemo(() => {
    ...
    // JS getDay() is 0=Sun, 1=Mon... we want Mon=0, Sun=6 for European/Figma standard
  ...
  const getStatusStyles = (status) => {
    switch (status) {
      ...
      case 'half':
        // Note: Using standard tailwind since exact Figma hex #bbf7d0 / #166534 aren't tokens
        return 'bg-green-200 text-green-800 font-medium';
      case 'leave':
        // Note: Using slate-100 since #f1f5f9 isn't a brand token
  ...
  return (
    <div className="flex flex-col min-h-full">
      {/* Header */}
      <header className="bg-surface border-b border-border flex items-center justify-between py-2 px-4 shrink-0 relative z-10">
